                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#ars_modal_Update_Paper_Metadata">
                            <i class="ki-outline ki-plus fs-2"></i> Update Paper Metadata
                        </button>
                        <!--end::Add user-->
                        @endif
                    </div>
                            ...
                            <div class="card-body p-10">
                                ...
                                <div class="mb-10">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a target="_blank" href="{{ $author['ORCID'] }}">{{ $author['ORCID'] }}</a>
                                ...
                                <div class="mb-8">
                                    ...
                                    <label
                                        ...
                                        <span class="form-check-label ms-0 fw-bold fs-6 text-gray-700">
                                            DOI: <a href="@if($metadata){{$metadata->doi}}@endif" target="_blank">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col">
                                            ...
                                            <a href="{{$metadata->pdf_link}}"
                                                class="btn btn-light btn-active-light-primary w-100 border border-primary"
                                    ...
                                    <button type=" submit" href="#" class="btn btn-primary w-100 "
                                        id="ars_is_my_research" data-id="{{$research->id}}"
                                        data-url="{{route('request')}}">
                                        <i class="ki-outline ki-triangle fs-3 "></i>
                                        This is my research ->{{$is_auther}}
                                    </button>
                                    @endif
                                </div>
                                <!--end::Actions-->
...
@endsection
@section('javascript')
<script src="{{ asset('assets/js/custom/apps/Research/paper/delete.js') }}"></script>
