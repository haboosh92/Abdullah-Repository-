...
@section('page-title')
<h1 class="text-gray-900 fw-bold my-1 fs-3 lh-1"> Research List </h1>
...
<ul class="breadcrumb fw-semibold fs-8 my-1">
    ...
    <li class="breadcrumb-item text-muted">
        Department: {{ $file->department->name }} - Yera: {{ $file->YearResearch->name }}
    </li>
                ...
                <div class="card-toolbar" style="xwidth: 20%;">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                            ...
                            <!--begin::Content-->
                            <form action="{{ route('fResearch') }}" method="POST">
                                @csrf
                        ...
                        <!--begin::Add user-->
                        <button type="button" class="btn btn-primary ars_modal_add_research" data-bs-toggle="modal"
                            data-bs-target="#ars_modal_add_research">
                            <i class="ki-outline ki-plus fs-2"></i> Add Research
                        </button>
                        <!--end::Add user-->
                        @endif
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                            ...
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px sorting align-items-center text-center" tabindex="0"
                                        aria-controls="kt_table_users" rowspan="1" colspan="1"
                                        aria-label="User: activate to sort column ascending" style="width: 30%;">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                @if (!empty($file))
                                @foreach ($file->research as $i =>$research )
                                <tr class="even" id="row-{{ $research->id }}">
                                    ...
                                    <td class="align-items-center">
                                        ...
                                        <div class="d-flex flex-column text-center">
                                            ...
                                            <span>email: {{ $scientificResearch->researcherInformation->email }}</span>
                                        </div>
                                    ...
                                    <td class="text-center ">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 ars_modal_edit_research"
                                                    data-bs-toggle="modal" data-bs-target="#ars_modal_edit_research"
                                                    id="edit_research_id-{{ $research->id  }}"
                                                    data-id="{{ $research->id }}" data-name="{{  $research->title}}"
                                                    data-url="{{ route('eresearch') }}">
                                                    Edit
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 ars_modal_delete"
                                                    data-id="{{ $research->id }}" data-name="{{ $research->title }}"
                                                    data-url="{{ route('dresearch') }}">
                                                    Delete
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                            @elseif(in_array(Auth::user()->role ,['Professor']))
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3 ars_modal_X"
                                                    data-id="{{ $research->id }}" data-name="{{ $research->title }}"
                                                    data-url="">
                                                    This is for me
                                                </a>
...
@include('Research.data.modal.add')
