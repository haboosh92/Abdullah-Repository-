...
@section('content')
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#ars_modal_upload_file">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    @foreach ($Files as $i => $file)
                                        <tr class="even" id="row-{{ $file->id }}">
                                            ...
                                            <td>
                                                <a href="{{ route('csv', ['id' => $file->id]) }}"> {{ $file->YearResearch->name }}</a>
                                            </td>

                                            <td data-order=" {{ $file->updated_at }}">
                                                <div class="badge badge-light fw-bold"> {{ $file->updated_at }}</div>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    {{-- <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3 xars_modal_edit"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3 ars_modal_delete"
                                                            data-id="{{ $file->id }}"
                                                            data-name="{{ $file->department->name . ' - ' . $file->name }}"
                                                            data-url="{{ route('dfile') }}">
                                                            Delete
                                                        </a>
                                                    </div>
                                                    <!--end::Menu item-->
    ...
    @include('Research.file.modal.add')
@endsection
@section('javascript')
